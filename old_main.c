...
//    int way;                   //направление целевой функцкии
...
//    printf("Enter the function direction(min -> 0, max -> 1): ");
//    do{                                                                      //Ввод направления функции
//        scanf("%d",&userData.way);
//        if(getchar()!='\n'||(userData.way!=0&&userData.way!=1))
//        {
//            fflush(stdin);
//            error(1);
//            valid=0;
...
//int undefiendFunction(struct count_data checkingCountData, struct data checkingData){
//    int i;
...
//int validPlane(struct count_data checkingCountData, struct data checkingData){
//    int i;
//    int result = 1;
//    if (checkingData.way)
